return {
  ...
  dependencies = {
    ...
    { 'theHamsta/nvim-dap-virtual-text',   lazy = true }, -- inline variable text while debugging

    -- https://github.com/nvim-telescope/telescope-dap.nvim
    { 'nvim-telescope/telescope-dap.nvim', lazy = true } -- telescope integration with dap
  },
  opts = {
    controls = {
      element = "repl",
